...
<div class="max-w-7xl mx-auto px-6 py-8">
    ...
    <section class="py-4">
        ...
        <div class="text-center mt-16">
            <a id="whats-institucional" href="<?= e(whatsappLink('Olá, tudo bem? Eu vim através do site e gostaria de fazer um orçamento.')) ?>" target="_blank" rel="noopener" class="primary-gradient text-white px-10 py-4 rounded-xl text-xs font-black uppercase tracking-widest shadow-lg hover:opacity-95 transition-opacity inline-flex items-center gap-2.5">
