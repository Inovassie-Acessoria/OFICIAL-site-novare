                    ...
                    <div class="max-w-7xl mx-auto px-6 w-full flex justify-start">
                        <div class="max-w-xl text-white py-12">
                            ...
                            <div class="flex flex-wrap gap-4">
                                ...
                                <?php endif; ?>
                                <a id="whats-home-hero" href="<?= e(whatsappLink('Olá, tudo bem? Eu vim através do site e gostaria de fazer um orçamento.')) ?>" target="_blank" rel="noopener" class="bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white/20 px-8 py-3.5 rounded-full font-black uppercase tracking-wider text-[10px] hover:scale-105 active:scale-95 transition-all inline-block">
                                    Falar com Equipe
                                </a>
                            </div>
                        </div>
    ...
    <div class="relative z-10 w-full">
        <div class="max-w-7xl mx-auto px-6 w-full flex justify-start">
            <div class="max-w-xl py-12 text-white">
                ...
                <div class="flex flex-wrap gap-4">
                    <a id="whats-home-final" href="<?= e(whatsappLink('Olá, tudo bem? Eu vim através do site e gostaria de fazer um orçamento.')) ?>" target="_blank" rel="noopener" class="primary-gradient text-white px-8 py-3.5 rounded-full font-black uppercase tracking-wider text-[10px] hover:scale-105 active:scale-95 transition-all shadow-lg inline-block">
